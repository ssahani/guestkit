...
GuestKit can export VM inspection results in multiple formats for documentation, compliance, and reporting purposes.
...
GuestKit supports two types of output:
...
<html lang="en">
<head>
    <title>GuestKit Inspection Report - fedora-server</title>
    <style>
...
*Generated by GuestKit - Pure Rust VM Inspection Toolkit*
````
...
<footer>
<p><small>Generated by GuestKit</small></p>
</footer>
</body>
</html>
EOF
